/* xgettext Ruby backend.
   Written by Stefan Hundhammer <shundhammer@suse.com>, 2020
   based on x-ycp.h written by Bruno Haible <haible@clisp.cons.org>, 2001.
...
{
  xgettext_record_flag ("_:1:pass-ruby-format");
  xgettext_record_flag ("gettext:1:pass-ruby-format");

#if 0
  // FIXME: Check if those work
  xgettext_record_flag ("dgettext:2:pass-ruby-format");
  xgettext_record_flag ("dcgettext:2:pass-ruby-format");
  xgettext_record_flag ("ngettext:1:pass-ruby-format");
  xgettext_record_flag ("ngettext:2:pass-ruby-format");
  xgettext_record_flag ("dngettext:2:pass-ruby-format");
  xgettext_record_flag ("dngettext:3:pass-ruby-format");
  xgettext_record_flag ("pgettext:2:pass-ruby-format");
  xgettext_record_flag ("dpgettext:3:pass-ruby-format");
#endif
}
...
/* 2. Replace each comment that is not inside a character constant or
   ...
   Ruby uses the hash sign '#' for comments like most scripting
   languages. */
...
#if 1
  // FIXME: No //  C++ -style comments in Ruby (unlike in YCP)
  if (c == '/')
    {
      c = phase1_getc ();
